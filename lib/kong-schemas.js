  ...
  '0.13': {
    ...
    route: {
      ...
      properties: {
        protocols: {
          display_name: "Protocol",
          description: "A list of the protocols this Route should allow. By default it is [\"http\", \"https\"], which means that the Route accepts both.",
          required: false,
          type: 'array',
          items: {
            type: 'string',
        ...
        methods: {
          display_name: 'Method(s)',
          description: "(semi-optional) A list of HTTP methods that match this Route. For example: [\"GET\", \"POST\"]. At least one of hosts, paths, or methods",
          required: false,
          type: 'array',
          items: {
            type: 'string',
        ...
        hosts: {
          display_name: "Host(s)",
          description: "(semi-optional) A list of domain names that match this Route. For example: example.com. At least one of hosts, paths, or methods must be set",
          required: false,
          type: 'json_array',
        },
        paths: {
          display_name: 'Path(s)',
          description: "(semi-optional) A list of paths that match this Route. For example: /my-path. At least one of hosts, paths, or methods must be set.",
          required: false,
          type: 'json_array',
        },
        strip_path: {
